...
echo -e "\n" '$#' "Prints the overall arguments used in the script : \e[34m $0 \e[0m"
echo -e "\n" '$?' "prints the exit code of the last command : \e[34m $0 \e[0m"
echo -e "\n" '$*' "Prints all the arguments used. : \e[34m $0 \e[0m"
echo -e "\n" '$@' "Prints all the arguments used. : \e[34m $0 \e[0m"
